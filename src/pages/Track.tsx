                ...
                {i < TIMELINE.length - 1 && (
                  <span
                    className={`mx-2 mb-0 h-0.5 flex-1 rounded-full sm:mb-5 ${
                      i < status.step ? "bg-accent" : "bg-muted"
                    }`}
                  />
                )}
              </li>
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-6 py-14">
        <div className="text-center">
          ...
          <h1 className="mt-4 text-3xl font-bold tracking-tight">{t("track.title")}</h1>
        ...
        <form onSubmit={search} className="mx-auto mt-8 flex max-w-md gap-2">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="h-12 w-full rounded-full border border-border bg-card pl-10 pr-4 text-sm outline-none transition-colors focus:border-accent"
            />
          </div>
          <button
            disabled={loading}
            className="inline-flex h-12 items-center gap-2 rounded-full bg-accent px-6 text-sm font-semibold text-white transition-all hover:opacity-90 active:scale-[0.98] disabled:opacity-50"
          >
